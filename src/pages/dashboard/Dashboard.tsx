    ...
    <LayoutBaseDePagina titulo="GaulesUI" barraDeFerramentas={<></>}>
      ...
      >
        <Box>
          ...
          componente, uma seção de comentários onde você pode usar dar sugestões
          e tirar dúvidas.
          <Box>
        ...
        <Box marginTop="30px">
          ...
          <a
            ...
            href="https://henriquembotelho.dev.br"
          >
          ...
          <ol>
            <li>
              ...
              : Uma engine para execução remota de código que pode ser usada
              para construir um site de aprendizado de algorotitmos e estrutura
              de dados como algoexpert, hackerrank e leetcode.
            </li>
            <li>
              <a
                style={{ color: theme.palette.text.secondary }}
              ...
              : Baseada no famoso site famoso site
              https://www.bigocheatsheet.com/ essa tabela dinâmica vai te ajudar
              a estudar algoritmos e estrutura de dados.
            </li>
            <li>
              <a
                style={{ color: theme.palette.text.secondary }}
              ...
              várias linguagens de paradigmas diferentes. Esse é o objetivo
              desse jogo e tutorial interativo.
            </li>
            <li>
              <a
                style={{ color: theme.palette.text.secondary }}
              ...
              apresenta um editor de código e chat em vídeo com a opção de
              salvar cógidos usando a API do GitHub.
            </li>
            <li>
              <a
                style={{ color: theme.palette.text.secondary }}
              ...
              : Um simples projeto para comparar a velocidade de execução de
              dois códigos.
            </li>
          </ol>
        </Box>
